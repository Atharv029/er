...
//           <br />
//           <hr className="w-[15%] h-[0.7%] bg-gray-200 border-0 dark:bg-gray-700 absolute top-[50%] left-[13%]" />
//           <p className="font-Jost absolute text-base top-[45%] left-[6%] text-[#606060]">Figma</p>
//           <p className='font-Jost absolute text-base top-[45%] left-[30%] text-[#606060]'>90%</p>

//           <div className='p-12 font-Jost font-[500] absolute text-xl top-[0%] right-[18%]'>Web Developer</div>
//           <p className='font-Jost absolute text-base top-[45%] right-[40%] text-[#606060]'>React Js</p>
//           <p className='font-Jost absolute text-base top-[45%] right-[15%] text-[#606060]'>90%</p>

//           <hr className="w-[18%] h-[0.7%] bg-gray-200 border-0 dark:bg-gray-700 absolute top-[50%] right-[20%]" />
//           <p className='font-Jost absolute text-base top-[60%] right-[42.8%] text-[#606060]'>Java</p>
//           <p className='font-Jost absolute text-base top-[60%] right-[15%] text-[#606060]'>80%</p>

//           <hr className="w-[21%] h-[0.7%] bg-gray-200 border-0 dark:bg-gray-700 absolute top-[65%] right-[20%]" />
//           <p className='font-Jost absolute text-base top-[78%] right-[36%] text-[#606060]'>HTML & CSS</p>
//           <p className='font-Jost absolute text-base top-[78%] right-[15%] text-[#606060]'>95%</p>

//           <hr className="w-[15%] h-[0.7%] bg-gray-200 border-0 dark:bg-gray-700 absolute top-[83%] right-[20%]" />
//         </div>
...
//               I am actively seeking an internship opportunity to gain hands-on experience in frontend development. Although I do not have prior professional experience, I am eager to apply my skills and learn from industry experts.
//             </div>
//           </div>
//         </div>
//       </div>
